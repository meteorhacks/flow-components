...
FlowComponents.getCurrent = function() {
  var currentView = Blaze.currentView;
  if(currentView) {
    return GetComponent(currentView);
  }
};

FlowComponents.get = function() {
  var component = FlowComponents.getCurrent();
  if(component) {
...
FlowComponents.emitAction = ActionHub.emit.bind(ActionHub);