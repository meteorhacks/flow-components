...
Template.leanComponent = new Template("Template.leanComponent", function() {
  var view = this;
  var componentName = Spacebars.call(view.lookup("name"));
  var params = Blaze._parentData();

  if(!componentName) {
    throw new Error("leanComponent needs name parameter");
  }
